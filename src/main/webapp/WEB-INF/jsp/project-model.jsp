...
<tr>
 <td height="26">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='/ProjectManager/skip.action?path=project-model-add.jsp';" value='添加新模块' />
 </td>
 </tr>
</table>
</td>
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="12" >&nbsp;模块列表&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>2015-02-03</td>
	<td>2015-06-03</td>
	<td><a href="/ProjectManager/skip.action?path=project-model-edit.jsp">编辑</a> | <a href="/ProjectManager/skip.action?path=project-model-look.jsp">查看详情</a></td>
</tr>
