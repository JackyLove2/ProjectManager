        ...
        <td height="26" >
            <table width="58%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <input type='button' class="coolbg np" onClick="location='/ProjectManager/skip.action?path=project-file-add.jsp';"
                               value='添加新附件'/>
                    </td>
                </tr>
            </table>
            ...
            <td background='/ProjectManager/static/skin/images/frame/wbg.gif' align='center'>
                <table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;<input value="搜索" type="button"  width="45" height="20" border="0" class="np"/>
                        </td>
                    </tr>
                </table>
            </td>
...
<form name="form2">
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
           style="margin-top:8px">
        <tr bgcolor="#E7E7E7">
            <td height="24" colspan="12">&nbsp;附件列表&nbsp;</td>
        </tr>
        ...
        <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
            ...
            <td>2015-02-03</td>
            <td>2015-06-03</td>
            <td><a href="#">下载</a> |<a href="#">删除</a> |<a href="/ProjectManager/skip.action?path=project-file-edit.jsp">编辑</a> | <a
                    href="/ProjectManager/skip.action?path=project-file-look.jsp">查看详情</a></td>
        </tr>
