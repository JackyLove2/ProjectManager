...
<tr>
 <td height="26" >
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='/ProjectManager/skip.action?path=resources-add.jsp';" value='添加菜单资源' />
 </td>
 </tr>
</table>
</td>
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="12">&nbsp;菜单资源列表&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>启用</td>
	<td><a >删除</a> |<a href="/ProjectManager/skip.action?path=resources-edit.jsp">编辑</a> </td>
</tr>
