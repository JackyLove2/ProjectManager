...
<tr>
 <td height="26" >
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='/ProjectManager/skip.action?path=role-add.jsp';" value='添加角色' />
 </td>
 </tr>
</table>
</td>
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="12">&nbsp;角色列表&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>启用</td>
	<td><a >删除</a> |<a href="/ProjectManager/skip.action?path=role-edit.jsp">编辑</a> | <a href="/ProjectManager/skip.action?path=role-look.jsp">查看详情</a></td>
</tr>
