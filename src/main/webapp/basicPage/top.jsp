...
<head>
    ...
    <link href="../static/skin/css/base.css" rel="stylesheet" type="text/css" />
    ...
    <style>
        ...
        {
            text-align:center;
            background:url(../static/skin/images/frame/topitembg.gif) 0px 3px no-repeat;
            width:82px;
            height:26px;
            line-height:28px;
        }
        ...
        *html .itemsel {
        ...
        .rmain {
            padding-left:10px;
            background:url(../static/skin/images/frame/topbg.gif) no-repeat;
        }
    </style>
...
<body bgColor='#ffffff'>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="/ProjectManager/static/skin/images/frame/topbg.gif">
    <tr>
        <td width='20%' height="60"><img src="../static/skin/images/frame/logo.gif" /></td>
            ...
            <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="right" height="26" style="padding-right:10px;line-height:26px;">
                        ...
                        [<a href="${rootpath}/skip.action?path=index.jsp" target="_top">主页</a>]
                        [<a href="${rootpath}/skip.action?path=modpassword.jsp"  target="_blank">修改密码</a>]
                        [<a href="javascript:void(0);" onClick="parent.location.href='${rootpath}/skip.action?path=login.jsp'" target="_login">注销退出</a>]&nbsp;
                    </td>
                </tr>
                <tr>
